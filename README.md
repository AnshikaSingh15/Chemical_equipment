# Chemical_equipment
Chemical Equipment Visualizer is a full-stack data analysis and visualization application designed to process, summarize, and visualize chemical equipment data from CSV files.
...
Start Web App (React)
cd web_front npm install npm start

App opens at: http://localhost:3000
Start Desktop App (PyQt5)
cd desktop_app pip install -r requirements.txt python main.py
